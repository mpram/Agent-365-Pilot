...
| 10 | [Onboarding Databricks Genie](Chapter%2010%20Databricks%20Genie/Onboarding-Databricks-Genie.md) | Connect **Databricks Genie** to Agent 365 using **Registry sync**, so Genie agents show up in the agent registry for centralized visibility and governance. |
