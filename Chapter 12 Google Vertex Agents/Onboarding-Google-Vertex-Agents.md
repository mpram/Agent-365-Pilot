...
Deployed Agent Engine (Reasoning Engine) instances bill a small runtime charge even when idle. To avoid surprises during the pilot:

- Set a **budget with email alerts** on the billing account (the Google Cloud equivalent of an Azure Cost Management budget). Example thresholds: 50% / 90% / 100%.

  ```powershell
  gcloud billing budgets create `
    --billing-account=<BILLING_ACCOUNT_ID> `
    --display-name="Vertex Pilot Budget" `
    --budget-amount=50USD `
...
- Delete the reasoning engines when the pilot is finished to stop the runtime charge.
...
- [Choose an Agent 365 integration option](https://learn.microsoft.com/microsoft-agent-365/developer/choose-integration-option)
- [Vertex AI Agent Engine](https://cloud.google.com/vertex-ai/generative-ai/docs/agent-engine/overview)
- [Create and manage service account keys (Google Cloud)](https://cloud.google.com/iam/docs/keys-create-delete)
- [Create, edit, and manage budgets (Google Cloud)](https://cloud.google.com/billing/docs/how-to/budgets)
